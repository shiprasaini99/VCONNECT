		...
		<>
			...
			<Modal isOpen={isOpen} onClose={onClose} size='xl'>
				...
				<ModalContent bg={"white"} border={"1px solid gray"}>
					...
					<ModalFooter>
						<Button backgroundColor={"black"} color={"white"} _hover={{ bg: "blackAlpha.200", color:"black" , border:"1px solid black"}} mr={3} onClick={handlePostCreation} isLoading={isLoading}>
							Post
						</Button>
					</ModalFooter>
				</ModalContent>
